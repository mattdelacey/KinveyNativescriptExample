...
var DropDown = (function (_super) {
    ...
    DropDown.prototype._setTextAttributes = function () {
        ...
        var text = types.isNullOrUndefined(this.nativeView.text) ? "" : this.nativeView.text.toString();
        var sourceString;
...
var DropDownListDataSource = (function (_super) {
    ...
    DropDownListDataSource.initWithOwner = function (owner) {
        var dataSource = DropDownListDataSource.new();
...
DropDownListDataSource.ObjCProtocols = [UIPickerViewDataSource];
...
var TNSDropDownLabel = (function (_super) {
    ...
    TNSDropDownLabel.initWithOwner = function (owner) {
        var label = TNSDropDownLabel.new();
        label._owner = owner;
    ...
    TNSDropDownLabel.prototype.touchesEndedWithEvent = function (touches, event) {
