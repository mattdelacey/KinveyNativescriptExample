import { ViewBase, Property, View } from "tns-core-modules/ui/core/view";
...
export class SwipeActionsEventData implements observableModule.EventData {
    eventName: string;
    object: observableModule.Observable;
    mainView: View;
    swipeView: View;
    itemIndex: number;
    data: any;
