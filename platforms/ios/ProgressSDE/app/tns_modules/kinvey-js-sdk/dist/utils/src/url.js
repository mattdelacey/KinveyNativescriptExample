...
function serialize(obj) {
  ...
  Object.keys(obj).forEach(function (prop) {
    ...
    if ((0, _object.isDefined)(val) === false) {
      ...
      query = options.encodeComponent === true ? encodeURIComponent(key) + '=' + encodeURIComponent(val) : key + '=' + val;
    }
...
function appendQuery(uri, query) {
  ...
  options = (0, _assign2.default)({ encodeComponents: true, removeNull: true }, options);
  parts.query = null;
