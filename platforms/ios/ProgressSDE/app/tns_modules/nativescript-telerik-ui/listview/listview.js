...
var TKListViewDelegateImpl = (function (_super) {
    ...
    TKListViewDelegateImpl.prototype.listViewShouldSelectItemAtIndexPath = function (listView, indexPath) {
        ...
        var owner = this._owner.get();
        var args = { eventName: commonModule.RadListView.itemSelectingEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section, returnValue: true };
        owner.notify(args);
    ...
    TKListViewDelegateImpl.prototype.listViewDidSelectItemAtIndexPath = function (listView, indexPath) {
        ...
        var owner = this._owner.get();
        var args = { eventName: commonModule.RadListView.itemSelectedEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section };
        owner.notify(args);
    };
    TKListViewDelegateImpl.prototype.listViewDidDeselectItemAtIndexPath = function (listView, indexPath) {
        ...
        var owner = this._owner.get();
        var args = { eventName: commonModule.RadListView.itemDeselectingEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section, returnValue: true };
        owner.notify(args);
        var argsDeselected = { eventName: commonModule.RadListView.itemDeselectedEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section };
    ...
    TKListViewDelegateImpl.prototype.listViewWillReorderItemAtIndexPath = function (listView, indexPath) {
        ...
        var owner = this._owner.get();
        var args = {
            eventName: commonModule.RadListView.itemReorderStartedEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section,
            data: undefined
        };
        owner.notify(args);
    };
    TKListViewDelegateImpl.prototype.listViewDidReorderItemFromIndexPathToIndexPath = function (listView, originalIndexPath, targetIndexPath) {
        ...
        var args = {
            eventName: commonModule.RadListView.itemReorderedEvent, object: owner, itemIndex: originalIndexPath.row, groupIndex: originalIndexPath.section,
    ...
    TKListViewDelegateImpl.prototype.listViewShouldSwipeCellAtIndexPath = function (listView, cell, indexPath) {
        ...
        if (owner.hasListeners(commonModule.RadListView.itemSwipingEvent)) {
            var args = { eventName: commonModule.RadListView.itemSwipingEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section, returnValue: true };
            owner.notify(args);
    ...
    TKListViewDelegateImpl.prototype.listViewDidLongPressCellAtIndexPath = function (listView, cell, indexPath) {
        ...
        var owner = this._owner.get();
        var args = { eventName: commonModule.RadListView.itemHoldEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section };
        owner.notify(args);
    };
    TKListViewDelegateImpl.prototype.listViewShouldLoadMoreDataAtIndexPath = function (listView, indexPath) {
        ...
        var owner = this._owner.get();
        var args = { eventName: commonModule.RadListView.loadMoreDataRequestedEvent, object: owner, itemIndex: indexPath.row, groupIndex: indexPath.section, returnValue: true };
        owner.notify(args);
        return args.returnValue;
    };
...
var TKListViewDataSourceImpl = (function (_super) {
    ...
    TKListViewDataSourceImpl.prototype.listViewCellForItemAtIndexPath = function (listView, indexPath) {
        ...
        owner.prepareCell(cell, indexPath);
        owner._preparingCell = false;
        return cell;
    };
...
var RadListView = (function (_super) {
    ...
    function RadListView() {
        ...
        _this._ios.registerClassForCellWithReuseIdentifier(ExtendedListViewCell.class(), "defaultCell");
        ...
        if (this._ios) {
            if (!this.scrollPosition) {
                if (this.listViewLayout.scrollDirection === commonModule.ListViewScrollDirection.Vertical) {
                    this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 1 /* Top */, false);
                }
                else {
                    this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 8 /* Left */, false);
                }
            }
            else {
                switch (this.scrollPosition) {
                    case commonModule.ListViewScrollPosition.Bottom:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 4 /* Bottom */, false);
                        break;
                    case commonModule.ListViewScrollPosition.CenteredHorizontally:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 16 /* CenteredHorizontally */, false);
                        break;
                    case commonModule.ListViewScrollPosition.CenteredVertically:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 2 /* CenteredVertically */, false);
                        break;
                    case commonModule.ListViewScrollPosition.Left:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 8 /* Left */, false);
                        break;
                    case commonModule.ListViewScrollPosition.None:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 0 /* None */, false);
                        break;
                    case commonModule.ListViewScrollPosition.Right:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), 32 /* Right */, false);
                        break;
