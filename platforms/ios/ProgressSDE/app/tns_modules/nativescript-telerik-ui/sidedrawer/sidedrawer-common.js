...
var RadSideDrawer = (function (_super) {
    ...
    RadSideDrawer.prototype.checkTransitionCompatibility = function () {
        if (this.showOverNavigation && this.drawerTransition) {
            var className = this.drawerTransition.constructor.name;
            switch (className.toLowerCase()) {
                case exports.RevealTransitionString: {
                    console.log("Warning: 'RevealTransition' is not supported when 'showOverNavigation' is set to 'true'.");
                    break;
                }
                case exports.ReverseSlideOutTransitionString: {
                    console.log("Warning: 'ReverseSlideOutTransition' is not supported when 'showOverNavigation' is set to 'true'.");
                    break;
                }
                case exports.ScaleUpTransitionString: {
                    console.log("Warning: 'ScaleUpTransition' is not supported when 'showOverNavigation' is set to 'true'.");
                    break;
                }
                default: {
                    break;
