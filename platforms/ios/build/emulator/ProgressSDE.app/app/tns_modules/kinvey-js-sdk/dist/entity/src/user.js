...
var _activeUserHelper = require('./activeUserHelper');
  ...
  _createClass(User, [{
    ...
    value: function login(username, password) {
      ...
      return request.execute().then(function (response) {
        ...
        _this.data = data;
        return _activeUserHelper.ActiveUserHelper.set(_this.client, _this.data);
      }).then(function () {
        return _this;
      });
    }
    ...
    value: function logout() {
      ...
      return request.execute().catch(function (error) {
        ...
        return _activeUserHelper.ActiveUserHelper.remove(_this5.client);
    ...
    value: function signup(data) {
      ...
      return request.execute().then(function (response) {
        ...
        if (options.state === true) {
          return _activeUserHelper.ActiveUserHelper.set(_this6.client, _this6.data);
        }
    ...
    value: function update(data) {
      ...
      return store.update(data, options).then(function (data) {
        if (_this7.isActive()) {
          return _activeUserHelper.ActiveUserHelper.set(_this7.client, data);
        }
    ...
    value: function me() {
      ...
      return request.execute().then(function (response) {
        ...
        if (_this8.isActive()) {
          return _activeUserHelper.ActiveUserHelper.set(_this8.client, _this8.data);
        }
    ...
    value: function getActiveUser() {
      ...
      var data = _activeUserHelper.ActiveUserHelper.get(client);
