...
var RadSideDrawer = (function (_super) {
    ...
    RadSideDrawer.prototype.onLayout = function (left, top, right, bottom) {
        ...
        if (pos === 2 /* Top */ || pos === 3 /* Bottom */) {
            if (pos === 3 /* Bottom */) {
                this._drawerContentHost.layout(0, screenHeight - drawerSize, screenWidth, screenHeight);
            }
            else {
                this._drawerContentHost.layout(0, 0, screenWidth, drawerSize);
            }
        }
        else {
            if (pos === 1 /* Right */) {
                this._drawerContentHost.layout(screenWidth - drawerSize, 0, screenWidth, screenHeight);
            }
            else {
