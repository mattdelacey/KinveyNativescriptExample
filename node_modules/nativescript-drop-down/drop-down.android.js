...
var DropDown = (function (_super) {
    ...
    DropDown.prototype.createNativeView = function () {
        var spinner = new android.widget.Spinner(this._context);
        ...
        var touchListener = new DropDownTouchListener(new WeakRef(this));
        spinner.setOnTouchListener(touchListener);
        spinner.touchListener = touchListener;
        return spinner;
    };
...
var DropDownTouchListener = (function (_super) {
    __extends(DropDownTouchListener, _super);
    function DropDownTouchListener(owner) {
        var _this = _super.call(this) || this;
        _this.owner = owner;
        return global.__native(_this);
    }
    DropDownTouchListener.prototype.onTouch = function (v, event) {
    ...
    return DropDownTouchListener;
}(java.lang.Object));
DropDownTouchListener = __decorate([
